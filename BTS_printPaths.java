...
/* 
    ...
    */
    ...
    public static void paths2Leaf(Node root , ArrayList<Integer> path)
    {
        if(root == null)
        {
            return;
        ...
        {
            paths2Leaf(root.left , path);
            paths2Leaf(root.right , path);
        }
